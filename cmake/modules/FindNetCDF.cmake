...
# Adapted from https://github.com/Kitware/VTK
...
if (netCDF_FOUND)
    ...
    find_library(NetCDF_LIBRARIES
            PATHS /Users/vincent/miniconda3/envs/test/lib
            NAMES netcdf
            DOC "netcdf library")
    ...
    message(STATUS "Found netCDF: ${NetCDF_LIBRARIES} (found version ${NetCDF_VERSION})")
